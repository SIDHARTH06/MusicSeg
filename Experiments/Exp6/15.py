...
class CustomResNet(nn.Module):
    def __init__(self, input_channels=27, num_classes=2):
...
# Example usage:
mfcc_dir = "../../Dataset A/Processed/Spectrogram/15swindow"
...
for fold, (train_index, val_index) in enumerate(kf.split(train_set)):
    ...
    pr_curve_save_path = os.path.join(results_folder, f"pr_curve_fold_{fold+1}_15.png")
