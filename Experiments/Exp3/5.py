...
# Example usage:
mfcc_dir = "../../Dataset B/Processed/MFCC/5"
...
hidden_size = 64
num_layers = 1
output_size = 78  # Number of LSTM units (one for each window)
...
with open('./result/res_5.txt', 'w') as f:
    ...
    plt.show()
    # Save the figure
    plt.savefig(f'result/precision_recall_curve_5_{fold}.png')
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig('result/evaluation_metrics_5.png')
    plt.show()
